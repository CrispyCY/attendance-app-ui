...
//cyroute
// user
const AppUserAccountUserProfile = Loadable(lazy(() => import('views/user/account-profile/UserProfile')));
const AppUserAccountNewUser = Loadable(lazy(() => import('views/user/account-profile/NewUser')));
const AppProfileList = Loadable(lazy(() => import('views/user/user-list')));

// student
const StudentProfile = Loadable(lazy(() => import('views/student/student-profile/StudentProfile')));
const NewStudent = Loadable(lazy(() => import('views/student/student-profile/NewStudent')));
const StudentList = Loadable(lazy(() => import('views/student/student-list')));

// teacher
const TeacherProfile = Loadable(lazy(() => import('views/teacher/teacher-profile/TeacherProfile')));
const NewTeacher = Loadable(lazy(() => import('views/teacher/teacher-profile/NewTeacher')));
const TeacherList = Loadable(lazy(() => import('views/teacher/teacher-list')));
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/user/account-profile/user-profile/:id',
            element: <AppUserAccountUserProfile />
        },//cy
        {
            path: '/user/account-profile/new-user',
            element: <AppUserAccountNewUser />
        },//cy
        {
            path: '/user/user-list',
            element: <AppProfileList />
        },//cy
        {
