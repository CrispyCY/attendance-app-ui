                                    ...
                                    <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                                        <Box sx={{ p: 2, pb: 0 }}>
                                            <Stack>
                                                ...
                                                <Typography variant="subtitle2">{user?.isAdmin ? 'Admin' : 'User'}</Typography>
                                            </Stack>
                                            {/* <OutlinedInput
                                            ...
                                            <Box sx={{ p: 2, pt: 0 }}>
                                                ...
                                                >
                                                    <ListItemButton
                                                        ...
                                                        onClick={(event) => handleListItemClick(event, 0, '/user/account-profile/user-profile/' + user?.memberId)}
                                                    >
                                                        <ListItemIcon>
